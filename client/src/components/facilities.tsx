  ...
  const facilities = [
    {
      ...
      image: "https://images.unsplash.com/photo-1515187029135-18ee286d815b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=400&h=250",
      color: "primary",
    },
    {
      icon: Bot,
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1560272564-c83b66b1ad12?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=400&h=250",
      color: "warning",
    },
    {
      icon: Laptop,
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1544717297-fa95b6ee9643?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=400&h=250",
      color: "secondary",
    },
  ];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {facilities.map((facility, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className={`w-20 h-20 bg-${facility.color}/10 rounded-full flex items-center justify-center mx-auto mb-6`}>
                <facility.icon className={`text-${facility.color}`} size={32} />
              </div>
